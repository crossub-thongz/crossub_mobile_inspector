      ...
      <Card className="w-full max-w-2xl border-border/70 bg-card/80 p-6 shadow-xl backdrop-blur sm:p-8">
        <div className="mb-6 flex items-center gap-3">
          ...
          <div>
            ...
            <h1 className="text-xl font-semibold text-foreground">Inspector Portal Access Agreement</h1>
          </div>
        </div>

        <p className="text-sm leading-relaxed text-muted-foreground">
          Before using the CROSSUB Inspector portal, you must read and accept the inspector
          portal access, confidentiality, privacy and field services compliance agreement.
          Your signed acceptance will be stored in HR.
        </p>
